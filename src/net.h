...
int netdial(int domain, int proto, int proto_num, char *local, int local_port, char *server, int port, int timeout);
int netannounce(int domain, int proto, int proto_num, char *local, int port);
